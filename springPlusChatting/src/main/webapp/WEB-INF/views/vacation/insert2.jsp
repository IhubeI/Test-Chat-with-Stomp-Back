...
<style>
.container {
	width: 640px; /* 너비를 설정합니다. */
	margin: 0 auto; /* 중앙 정렬을 위해 마진을 자동으로 설정합니다. */
	padding: 20px; /* 내부 여백을 추가합니다. */
	border: 1px solid #ccc; /* 컨테이너의 테두리 설정 (선택 사항) */
	border-radius: 5px; /* 모서리 둥글게 설정 (선택 사항) */
	box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* 그림자 옵션 */
}
</style>
...
<script>
	...
	function calendar2() {
		...
		if (document.getElementById(id).innerText !== ''
				&& document.getElementById(toid).innerText < document
	...
	<div class="container">
		...
		<table width="640" class="data bordertop2">
			...
			<tr>
				...
				<td class="bg" colspan="3" style="cursor: pointer;" onclick="atuses();">&nbsp;&nbsp;<b><span id="year"></span></b>년&nbsp;&nbsp;&nbsp;&nbsp; 총 : <b><span id="tot"></span></b>일&nbsp;,&nbsp;&nbsp;&nbsp;&nbsp; 사용 : <b><span id="use"></span></b>일&nbsp;,&nbsp;&nbsp;&nbsp;&nbsp; 남은일수 : <b><span id="rem"></span></b>일
				</td>
			</tr>
			<tr>
				<td class="stit">구분</td>
			...
			<tr>
				<td colspan="4">
					...
					<div class="tmsedit minheight50" tms_edit id="reason" style="padding: 8px; width: 610px; overflow: auto;"></div>
			...
			<tr>
				...
				<td colspan="3" class="textleft tmsselect" onclick="fun('comment', 'cmt', '[{TIME}] [{NAME}] {COMMENT}<BR>');" title="승인 후 업무 기록">
					<div id="cmt"></div>
				</td>
			</tr>
		</table>
