            ...
            <main id="body"> 
                <div id="content">
                    <body>
                        ...
                        <form action="/vacation/insert"  method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="table-container">
								<table class="table">
									...
									<tbody>
										<tr>
											<td>${vacationApplyVO.approDate}</td>
											<td><input type="checkBox" name="approBos1" value="${vacationApplyVO.approBos1 }"></td>
											<td><input type="checkBox" name="approBos2" value="${vacationApplyVO.approBos2 }"></td>
											<td><input type="checkBox" name="approBos3" value="${vacationApplyVO.approBos3 }"></td>
											<td><input type="text" name="approYN" value="${vacationApplyVO.approYN }" readonly></td>
										</tr>
									</tbody>
								</table>
							</div>
                            ...
                            <div class="row flex-box">
                                <div>
                                    <div class="row">
                                        <label>사원명</label>
                                        <input type="text" class="filed form" name="name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div>
                                    <label>사원번호</label>
                                    <input type="number" name="approNo2" class="form" placeholder="ex: 3892" maxlength="4">
                                </div>
                                <div>
                                    <label>직급</label>
                                    <select class="form" name="levelCd">
                            ...
                            <div class="row">
                                <div>
                                    <label>EMAIL</label>
                                    <input type="text" name="empEmail" class="form" placeholder="email@example.com">
                                </div>
                                <div>
                                    <label>휴대폰 번호</label>
                                    <input type="number" class="form" placeholder="00011112222" name="vacaTel">
                                </div>
                            </div>
                            ...
                            <div class="row flex-box">
                                <div class="w-50">
                                    <label>휴가 시작일</label>
                                    <input type="text" class="field w-100 test7-1 form" name="vacaSdate">
                                </div>
                                <div class="w-50">
                                    <label>휴가 종료일</label>
                                    <input type="text" class="field w-100 test7-2 form" name="vacaEdate">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div>
                                  	<label>휴가 종류</label>
                                   	<select class="form" name="vacaType">
